...
type UserServiceClient interface {
	...
	UpdateUserById(ctx context.Context, in *UpdateUserByIdRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) UpdateUserById(ctx context.Context, in *UpdateUserByIdRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	UpdateUserById(context.Context, *UpdateUserByIdRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) UpdateUserById(context.Context, *UpdateUserByIdRequest) (*UserResponse, error) {
